const allowDataType = ['path', 'blob', 'dataUrl', 'string']
export default function download(data, strFileName, strMimeType, type) {
  if (allowDataType.includes(strFileName)) {
    type = strFileName
    strFileName = ''
    strMimeType = ''
  }
  ...
  if(type === 'dataUrl' || /^data:([\w+-]+\/[\w+.-]+)?[,;]/.test(payload)){
